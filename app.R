  ...
  dashboardBody(
    fluidPage(theme = shinytheme("cerulean"),
              ...
              fluidRow(column(4,selectInput(inputId = "format",
                                           ...
                                           choices = c(Choose="","All","Test","ODI","	T20I"),selectize = TRUE,
                                           selected = NULL
                                           )),
              ...
              fluidRow(tabBox(width = "auto",
                ...
                tabPanel("Statistics", 
                         ...
                         downloadLink("dwnld", "Download record")
                         ),
                tabPanel("Authors",
                         br(),
...
server <- function(input,output,session){
  ...
  setnames(batting_odi,
           ...
           c("Matches Played","Innings","NotOuts","Runs","Highest Score","Batting average","Balls faced","Strike rate","#100s","#50s"))
  ...
  setnames(bowling_odi,
           ...
           c("Matches Played","Innings","Balls","Runs","Wickets","Best Bowl Inngs","Best Bowl Match","Bowling average","Economy","Strike rate","#4Wkcts","#5Wkcts","#10Wkcts"))
      ...
      if(input$st!=""){
        data=data()
          ...
          output$dwnld<-downloadHandler(
            filename = function() {
              paste("Career statistics of players of state ",input$st, Sys.Date(),".xlsx", sep="")
            },
            content = function(file)
            {
              ...
              write.xlsx(list(batting_record=df_bat,
                              bowling_record=df_bowl),file, 
